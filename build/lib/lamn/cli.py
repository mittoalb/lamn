...
def main():
    ...
    # Client commands (now with "list" subcommand)
    ...
    # Command to add an agent IP address.
    ...
    if args.command == 'server':
        if args.action == 'start':
            ...
            try:
                # Send a shutdown request to the server; adjust if necessary.
        ...
        if args.action == 'start':
            ...
            try:
                # Send a shutdown request to the client; adjust if necessary.
